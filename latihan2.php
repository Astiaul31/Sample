...
<body >
    <h1 align="center">LIST WISATA YOGYAKARTA</h1>
        ...
        <tr>
          ...
          <td></td>
            ...
            <tr>
                ...
                <td><input type="submit" value="KLAIN" name="proses"></td>
            </tr>
        </table>
        <?php
        ...
        ?>
         ...
         <?php }elseif($destinasi == "7"){ ?>
                  ...
                  <div  class="cafe">
                        ...
                        <option value="3">roti Bakar</option>
                        <option value="4">Milk Shack</option>
                      </select>
